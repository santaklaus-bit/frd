...
export default async function AdminDashboard() {
  ...
  const stats = [
    ...
    { label: "Expertise", value: initiatives.length, icon: Target, href: "/admin/expertise", color: "text-blue-500" },
    { label: "Projets", value: production.length, icon: Video, href: "/admin/projects", color: "text-purple-500" },
  ...
  const quickActions = [
    ...
    { href: "/admin/expertise", label: "Expertise", description: "Gérer vos domaines d'expertise", icon: Target },
    { href: "/admin/projects", label: "Projets", description: "Interviews, podcasts, réalisations, etc.", icon: Video },
